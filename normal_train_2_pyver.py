...
for epoch in range(train_epochs):
    ...
    for current_segment, target in train_loader:
        ...
        # save checkpoint
        if batch % save_cehckpoint_batch == 0:
...
# %%
#torch.save(net, './REAN_nets/meth_abuser6969123_attn_stack.pth')
